...
import com.lyl.cacheweb.webview.BaseWebChromeClient;
import com.lyl.cacheweb.webview.Html5WebView;
...
public class Html5Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isSupportCss) {
            mWebView.supportCssStyle(R.raw.night);
        }
    ...
    // 继承 WebView 里面实现的基类
    private class Html5WebChromeClient extends BaseWebChromeClient {
    ...
    public void getParameter() {
        ...
        if (bundle != null) {
            ...
            isSupportCss = bundle.getBoolean("support_css");
        } else {
            mUrl = "https://wing-li.github.io/";
        }
        Log.d(TAG, "getParameter:: isSupportCss: " + isSupportCss);
    }
